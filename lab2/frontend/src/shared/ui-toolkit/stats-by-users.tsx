...
function normalizeStats(res: unknown): ObjectsPerUserStats[] {
    const arr = Array.isArray(res) ? res : Array.isArray((res as Record<string, unknown>)?.stats) ? (res as Record<string, unknown>).stats : [];
